...
function GetAssetPath(relativePath){
	return `${GetSiteBase()}/Assets/${relativePath}`;
}
...
export async function loadHeaderFooter(){
	await loadSharedPart("#shared-header", GetAssetPath("HTML/header.html"));
	watchHeaderHeight();
	await loadSharedPart("#shared-footer", GetAssetPath("HTML/footer.html"));
}
